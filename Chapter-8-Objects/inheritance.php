...
// example: anything missing related to abstract classes/methods? Hypothetical progammer
// has forgotten to add getArea() method in the following required by the avoe ShapeInfo Class
