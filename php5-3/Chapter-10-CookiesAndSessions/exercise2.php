...
// Rewrite the 3-step registration form from Chapter 9 that used hidden form fields using 
// sessions to store the form data so users can return where they left off. 
// Erase the entered data from the session once the registration process is completed.
