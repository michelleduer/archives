...
function addItem() {
	...
	// forces $_SESSION array to be writen to the session file on the server's hard disk
	session_write_close();
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<h1>A Shopping Cart Using Sessions</h1>
...
?>
		...
		<dd>$<?php echo number_format($product->getPrice(), 2) ?><a href="shopping_cart.php?action=removeItem&productId=<?php echo $product->getId() ?>"> Remove</a></dd>
<?php } ?>
		<dt>Cart Total:</dt>
...
<?php foreach ($products as $product) { ?>
		<dt><?php echo $product->getName() ?></dt>
		<dd>$<?php echo number_format($product->getPrice(), 2) ?><a href="shopping_cart.php?action=addItem&amp;productId=<?php echo $product->getId() ?>"> Add Item</a></dd>
